...
The egui/glass works on top of eobjects data abstraction library, and inherits it's functionality: High level "ecom" protocol connects multiple processes together as one eobjects tree. IO device network communication, "iocom", is also readily visible from the egui.
