...
Uncompress source code. I uncompressed mbedtls-3.6.5.tar.bz2 to /home/iocafe/mbedtls/mbedtls-3.6.5 
(now this is the MbedTLS source root folder). 

Run cmake and build/install with GNU make. I created directory /home/iocafe/mbedtls/build 
to be used as build directory:
