...
The MbedTLS library is used for Transport Layer Security, TLS. 
It is used for platforms like Linux, Windows and ESP32 which
are powerful enough to support secured TCP communication.
