...
* /coderoot/eosal/util/json - Command line utility to compress/uncompress JSON
...
***********************************************
The Arduino style enviromnemt expect libraries as souce code, organized in a specific manner under one folder. 
...
Open issues
***********
* There are a few pre compiled Linux/Windows binaries for MbedTLS and OpenSLL in /coderoot/eosal/dependencies.
